/**
 * This is a component for the footer of each webpage.
 */
    ...
    return (
        ...
        <footer className="justify-end">
            <div className="py-6 px-4 flex items-center justify-between">
                <span className="text-sm text-gray-700">© 2022 <a href="https://www.gatech.edu/">Georgia Institute of Technology</a>. All Rights Reserved.
                </span>
